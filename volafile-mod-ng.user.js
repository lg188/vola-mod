...
try {
    ...
    function s_Load() {
        vola_mod_ng = JSON.parse(localStorage.vola_mod_ng); //jshint ignore:line
    }

	  function s_Save() {
        localStorage.vola_mod_ng = JSON.stringify(vola_mod_ng); //jshint ignore:line
    }
	  ...
	  function doRoom() { //jshint ignore:line
		    ...
		    if (typeof vola_mod_ng.data === 'undefined') {
            vola_mod_ng.data = {} ;
        }

		    if (typeof vola_mod_ng.data[id] === 'undefined') {
            vola_mod_ng.data[id] = {};
        }
            ...
            vola_mod_ng.data[id].disabled = this.config.disabled;
        }
